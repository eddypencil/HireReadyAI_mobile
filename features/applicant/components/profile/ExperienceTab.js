...
function EmptySection({ text, onAdd, viewOnly }) {
  ...
  const styles = createStyles(c);
  return (
    <TouchableOpacity style={styles.emptyRow} onPress={!viewOnly ? onAdd : null} disabled={viewOnly} activeOpacity={0.75}>
...
export default function ExperienceTab({ profile, viewOnly, onEdit, onDelete }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Work Experience — grey/blue same as current */}
      <View style={styles.section}>
        <SectionHeader title={t("profile.work_experience")} icon="briefcase-outline" onAdd={() => onEdit("experience", null, null)} viewOnly={viewOnly} />
        {experience.length === 0 ? (
      ...
      {/* Education — purple */}
      <View style={styles.section}>
        <SectionHeader title={t("profile.education")} icon="school-outline" onAdd={() => onEdit("education", null, null)} viewOnly={viewOnly} />
        {education.length === 0 ? (
      ...
      {/* Volunteering — green */}
      <View style={styles.section}>
        <SectionHeader title={t("profile.volunteering")} icon="heart-outline" onAdd={() => onEdit("volunteering", null, null)} viewOnly={viewOnly} />
...
function createStyles(c) {
  return StyleSheet.create({
    ...
    sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 18, borderBottomWidth: 1, borderBottomColor: c.border },
    ...
    itemCard: { flexDirection: "row", alignItems: "flex-start", gap: 12, padding: 16, borderTopWidth: 1, borderTopColor: c.border },
    itemIcon: { width: 40, height: 40, borderRadius: 10, alignItems: "center", justifyContent: "center", flexShrink: 0 },
