...
export function getPercentileTag(percentile) {
  ...
  if (percentile >= 99) return { label: 'Top 1%' };
  if (percentile >= 95) return { label: 'Top 5%' };
  if (percentile >= 90) return { label: 'Top 10%' };
  if (percentile >= 75) return { label: 'Top 25%' };
  if (percentile >= 50) return { label: 'Top 50%' };
