      ...
      >
        <View style={styles.jobListItemContent}>
          ...
          <View style={styles.jobListMeta}>
            <Text style={styles.jobListSeniority}>
              {job.seniority_level || "Any"}
            </Text>
            <Text style={styles.jobListDot}>·</Text>
            <Text style={styles.jobListApplicants}>
        ...
        <View
          style={[
            styles.statusDot,
            status === "Published" ? styles.statusDotActive : styles.statusDotInactive,
          ]}
        />
      </TouchableOpacity>
    );
    ...
    return (
      <ScrollView style={styles.detailContainer} contentContainerStyle={styles.detailContent}>
        ...
        <View style={styles.contentRow}>
          {/* Responsibilities */}
          <View style={[styles.contentCard, styles.contentCardHalf]}>
