...
export default function ForgotPasswordPage() {
  ...
  const s = {
    ...
    subheading: { fontSize: 14, fontFamily: FONT_FAMILY, color: c['sidebar-foreground'], marginBottom: 32 },
    emailHighlight: { fontFamily: FONT_FAMILY_SEMIBOLD, color: c['sidebar-foreground'] },
    form: { gap: 16 },
    fieldGroup: { gap: 6 },
    ...
    successText: { fontSize: 14, fontFamily: FONT_FAMILY, color: c.foreground, lineHeight: 20 },
    spamNote: { fontSize: 12, fontFamily: FONT_FAMILY, color: c['sidebar-foreground'] },
  };
