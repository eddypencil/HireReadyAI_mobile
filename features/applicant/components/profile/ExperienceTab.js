  ...
  return (
    ...
    >
      ...
      <Text style={styles.emptyText}>
        {viewOnly ? t("profile.nothing_added") : text}
      </Text>
    </TouchableOpacity>
  );
}
    ...
    <View style={styles.container}>
            ...
            <ItemCard
              ...
              title={
                [item.level, item.major]
                  .filter(Boolean)
                  .join(t("profile.education_in")) || item.university
              }
      ...
      <View style={styles.section}>
        ...
        {volunteering.length === 0 ? (
          <EmptySection
            text={t("profile.add_volunteering")}
            onAdd={() => onEdit("volunteering", null, null)}
            viewOnly={viewOnly}
          />
        ) : (
