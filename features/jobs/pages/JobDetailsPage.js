...
export default function JobDetailsPage() {
  ...
  const s = {
    ...
    statusText: { marginTop: 12, color: c['muted-foreground'], fontSize: 15, fontFamily: FONT_FAMILY },
    ...
    companyLogoText: { fontSize: 18, color: c.primary, fontFamily: FONT_FAMILY_BOLD },
    companyName: { fontSize: 15, color: c.foreground, fontFamily: FONT_FAMILY_SEMIBOLD },
    locationRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 2 },
    companyLocation: { fontSize: 12, color: c['muted-foreground'], fontFamily: FONT_FAMILY },
    jobTitle: { fontSize: 22, color: c.foreground, marginBottom: 12, lineHeight: 30, fontFamily: FONT_FAMILY_BOLD },
    ...
    tagText: { fontSize: 12, color: c.accent, fontFamily: FONT_FAMILY_MEDIUM },
    salaryRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 16 },
    salaryText: { fontSize: fontSize.sm, color: c.primary, fontFamily: FONT_FAMILY_SEMIBOLD },
    salaryConfidential: { fontSize: fontSize.sm, color: c['muted-foreground'], fontFamily: FONT_FAMILY },
    ...
    applyButtonText: { color: c['destructive-foreground'], fontSize: 15, fontFamily: FONT_FAMILY_SEMIBOLD },
    ...
    sectionTitle: { fontSize: 16, color: c.foreground, marginBottom: 12, fontFamily: FONT_FAMILY_BOLD },
    bodyText: { fontSize: fontSize.sm, color: c['muted-foreground'], lineHeight: 22, fontFamily: FONT_FAMILY },
    bulletRow: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 10 },
    bullet: { width: 6, height: 6, borderRadius: 3, backgroundColor: c.accent, marginTop: 8, marginRight: 10, flexShrink: 0 },
    bulletText: { fontSize: fontSize.sm, color: c['muted-foreground'], lineHeight: 22, flex: 1, fontFamily: FONT_FAMILY },
    ...
    skillTagText: { fontSize: 13, color: c.accent, fontFamily: FONT_FAMILY_MEDIUM },
    ...
    similarJobLogoText: { fontSize: 16, color: c.primary, fontFamily: FONT_FAMILY_BOLD },
    similarJobTitleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 8 },
    similarJobTitle: { fontSize: fontSize.sm, color: c.foreground, flex: 1, fontFamily: FONT_FAMILY_SEMIBOLD },
    similarJobMeta: { fontSize: 12, color: c['muted-foreground'], marginTop: 3, fontFamily: FONT_FAMILY },
    ...
    similarTagText: { fontSize: 11, color: c.accent, fontFamily: FONT_FAMILY_MEDIUM },
    similarJobDate: { fontSize: 11, color: c['muted-foreground'], marginTop: 6, fontFamily: FONT_FAMILY },
  };
